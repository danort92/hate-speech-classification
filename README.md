...
| hateBERT — Baseline            | 0.7722  | 0.5116       | 0.7553    | 0.6797   |
| hateBERT — Improved            | 0.7707  | 0.5427       | 0.7319    | 0.6818   |
| hateBERT — Targeted aug. (4c)  | 0.7688  | 0.4859       | 0.7620    | 0.6722   |
...
| hateBERT — Baseline (4a)              | 0.6797   | 0.5137        | −0.1660 |
| hateBERT — Improved (4b)              | 0.6818   | 0.5802        | −0.1015 |
| hateBERT — Targeted aug. (4c)         | 0.6722   | 0.5988        | **−0.0734** |
...
- **hateBERT improved is the best overall model** (macro F1 0.6818), outperforming DistilBERT (0.662), TF-IDF + LR (0.650), and BiLSTM (0.605)
- **TF-IDF + LR is surprisingly competitive** — only 0.0318 F1 behind the best hateBERT result, and it trains in seconds with no GPU
...
- **hateBERT is the most robust under targeted obfuscation after mitigation** (drop −0.1660 baseline, −0.0734 with Task 4c) — domain-specific pre-training on abusive text provides a stronger prior for recognising obfuscated slurs via WordPiece subword decomposition
...
| hateBERT | −0.0075 (0.6797→0.6722) | +0.0926 drop reduction |
